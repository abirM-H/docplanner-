...
{title:"Career"},
{title:"Departments", SousMenu:["Marketing & PR","Customer Success & Sales","IT, Product, Design & UX","Finance & Administration","HR & More"]}]

let Description =[{Paragraphe:"We want patients to find the perfect doctor and book an appointment in the most easy way. The patient journey should be enjoyable, and thats why we are always next to them: to help them find the best possible care. Anytime, anywhere."},
...
let cardList =[{type:"For patients",
description:"Find a doctor, book a visit and solve any health-related doubt",
      ...
      },
 {
   ...
   let listPalatform =[{
     ...
     padding: "padding",
    paddingCountry: "padding-country"
   },
...
let tabfooter=[{firstcountrie:'Poland'},
  {firstcountrie:'Turkey'},
  {firstcountrie:'Spain'},
  {firstcountrie:'Italy'},
  {firstcountrie:'Czech Republic'},
  {firstcountrie:'Mexico'},
  {firstcountrie:'Colombia'},
  {firstcountrie: 'Brazil'},
  {firstcountrie:'Argentina'},
  {firstcountrie:'Chile'},
  ...
  render(){
    return (
      <div className="App">
        ...
        <img className='logo-navbar' src="https://www.docplanner.com/img/logo-default-group-en.svg?v=1"/>
        <Navbar menu={menu}/>
        </div>
        <div className='header'>
        <img className='header-logo' src="https://www.docplanner.com/img/sygnet@2x.png"/>
        <h1>Making the healthcare experience more human</h1>
        </div>
        <div className='descrip'>
          <Paragraphe Description={Description}/>
        </div>
        <BoxSearch cardList={cardList} />
        <div className='company-sector'>
          <p className='text-company'>We are a global company with local culture</p>
          <Company ListCompany ={ListCompany}/>
        </div>
        </div>
        <div className='section-platform'> 
           <div className='first-platform'>
              <p className='titlePlatform'>The world's biggest healthcare platform</p>
              <p className='paraPlatform'>We work from 6 offices all over the world, bringing Docplanner Group to life in almost 20 countries.</p>
              <img className='img-platform'src='https://www.docplanner.com/img/logo.png'/>
           </div>
          <Platform listPalatform={listPalatform}/>
        </div>
       <div className='office-items'>
        ...
        <div className='my-cards'>
          <Cards tabCards={tabCards}/>
        </div>
        <div className='my-footer'>
          <div className='contryleaders'>
            <p>
            We are leaders in 10 countries:
            </p>
            <Footer tabfooter={tabfooter}/>
           </div>
           <p className="paragfooter">This site uses cookies to deliver services in accordance with this Privacy Policy. You can specify the conditions for storing or accessing cookies on your browser.
